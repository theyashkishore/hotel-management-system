...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 (90)00-100-200</li>	
				</ul>
			</div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/yash.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/amish.jpeg" alt=" " class="img-responsive" />
					</li>
					</ul>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Yash Kishore</h4>
							<span>Manager</span>
							<p>We have made this project with ❤️. I enjoyed the making process while exploring php and SQL. We thanks our respective faculties.</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>The rooms were clean, very comfortable, and the staff was amazing. 
									...
									I highly recommend this hotel for anyone visiting downtown Jaipur.</p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>They were extremely accommodating and allowed us to check in early at like 10am. 
									We got to hotel super early and I didn’t wanna wait. So this was a big plus. 
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>The staff at this property are all great! 
									They all go above and beyond to make your stay comfortable. 
									Please SUNRISE give your staff awards!</p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Excellent property and very convenient to USC activities. 
									Front desk staff is extremely efficient, pleasant and helpful. 
									Property is clean and has a fantastic old time charm.</p>
								<h5>Amie Bublitz</h5>
								<p>Switzerland</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 90(00)-100-200</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Manipal University Road, Jaipur, India</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.7490183191194!2d75.56672071496874!3d26.847933983155563!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396c4855d3fe343d%3A0x7bc7d8fcbf8ccb20!2sVinayak%20Marg%2C%20Dahmi%20Kalan%2C%20Rajasthan%20303007!5e0!3m2!1sen!2sin!4v1652860296387!5m2!1sen!2sin" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
