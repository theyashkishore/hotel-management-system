...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>SUNRISE HOTEL,</p>
				<p>Manipal University Road,<br>Jaipur, India</p>
				<p>(+91) 9000 100 200</p>
			</address>
		...
		<article>
			...
			<table >
					...
					<tr> 
						<td>Passport Country : -  <?php echo $country; ?> </td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@sunrise.com || Web :- www.sunrise.com || Phone :- +91 9000 100 200</p>
			</div>
		</aside>
	</body>
</html>
